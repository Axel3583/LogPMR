...
@Component({
  selector: 'logpmr-main',
  standalone: true,
  imports: [
    CommonModule, 
    FirstlySectionHomeComponent, 
    SecondlySectionHomeComponent, 
    ThirdlySectionHomeComponent,
    FourthlySectionHomeComponent, 
    FifthlySectionHomeComponent,
    SixthlySectionHomeComponent, 
    FooterComponent
  ],
